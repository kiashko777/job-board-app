    ...
    <form method="POST" action="/login">
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-800 pb-12">
                <h2 class="text-base font-semibold leading-7 text-gray-100">Sign Into Your Account</h2>
                <p class="mt-1 text-sm leading-6 text-gray-400">Welcome back! Please enter your credentials.</p>
